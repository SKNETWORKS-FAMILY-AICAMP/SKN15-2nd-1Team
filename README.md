...
특히 통신 서비스는 가입자에게 대체 가능한 일반재(commodity)로 인식되기 쉽고, 통신사 간 제공하는 서비스가 엇비슷해 소비자에게 차이를 느끼게 하기 어렵습니다. 이러한 경쟁 상황 속에서 통신사들은 가격 외에도 고객 경험, 서비스 품질, 혜택 등 다방면에서의 차별화 전략을 펼치려 하고 있고, 이에 따라 통신사업자 간의 경쟁은 앞으로도 더욱 심화될 것으로 예상됩니다. <p>
[삼일회계법인, 「통신산업 경쟁 현황 : 경쟁우위를 위한 5가지 방안](https://www.pwc.com/kr/ko/insights/industry-focus/samilpwc_state-of-competition-and-commoditisation.pdf)
...
## ❤️ 기대효과
* **고객 이탈 방지 전략 수립**
  * 머신러닝 모델을 통해 고객 이탈 가능성이 높은 고객을 조기에 파악함으로써, 맞춤형 마케팅 및 유지 전략을 세울 수 있습니다.
* **비지니스 효율성 향상**
  * 이탈 가능성이 낮은 고객에게 과도한 마케팅 비용을 줄이고, 이탈 가능성이 높은 고객에게 자원을 집중함으로써 비용 대비 효율을 극대화할 수 있습니다.
* **서비스 품질 개선 및 고객 만족도 향상**
  * 분석 결과를 바탕으로 고객 불만 요소나 서비스 개선점을 도출하여, 고객 경험을 개선하고 장기적인 고객 충성도를 높일 수 있습니다.
* **실시간 또는 정기적 자동화 시스템 연동 가능**
...
* **통신사 CRM 및 마케팅 부서 담당자 🕵️‍♂️**
  * 고객 이탈 가능성이 높은 세그먼트를 식별하여 개인화된 유지 프로모션을 제공할 수 있습니다.
  * 이탈 예측 점수를 활용하여 우선 대응 고객 리스트를 자동 생성할 수 있습니다.
* **전략기획 및 경영진 👨‍💼**
  * 고객 이탈 주요 요인을 요약한 대시보드 기반 인사이트를 확보할 수 있습니다.
  * 고객군 별 이탈율 추이 분석을 통해 요금제를 리디자인할 수 있고, 서비스 개선 방안을 도출할 수 있습니다.
* **CRM 개발자 및 운영자 👨‍💻**
...
# 8. Streamlit
|<img width="450" height="225" alt="Image" src="https://github.com/user-attachments/assets/af064011-12ec-4a50-a1c1-cba673305ac1" />|<img width="450" height="225" alt="Image" src="https://github.com/user-attachments/assets/07c41267-826c-4cea-b30b-3841555893cb" />|
|-------------------------|----------------|
|<img width="450" height="225" alt="Image" src="https://github.com/user-attachments/assets/0d855e3a-8dcb-4436-81ee-a6bebb2f4a8a" />|<img width="450" height="225" alt="Image" src="https://github.com/user-attachments/assets/35a89399-0054-4ffa-9504-ced77dd3492d" />|
...
| 기현택     | 김주형     | 이소정     |
| ---------- | ---------- | ---------- |
|프로젝트에서 처음 팀장을 맡았는데, 떨리기도 하고 걱정도 되었지만 무사히 잘 마무리 된 것 같습니다. 팀원들과 소통하고 협업하고 문제를 발견하고 해결하는 과정 자체가 아주 소중한 경험이었고 모든 팀원들 고생하셨습니다.|스트림릿을 활용한 화면 설계 전반을 담당하며 사용자 친화적인 인터페이스 구현에 중점을 뒀습니다.
특히 예측 시뮬레이션 기능을 개발해 사용자가 직접 다양한 입력값으로 결과를 확인할 수 있도록 구성했습니다.
이외에도 EDA와 모델 성능 평가 작업에 함께 참여하며 프로젝트의 전체 흐름을 이해하고 팀원들과 협업하였습니다.|기대만큼 성능이 오르지 않아 아쉬움이 남았다. 다양한 시도를 하기엔 시간이 부족했지만, 다음 프로젝트에서는 더 나은 전략과 시간 관리로 성능 개선을 이끌어내고 싶다.|
