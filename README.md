...
이러한 배경을 바탕으로, Kaggle에서 제공하는 [Cell2Cell Churn Prediction 데이터셋](https://www.kaggle.com/datasets/jpacse/datasets-for-churn-telecom)을 활용하여, 통신사 고객의 이탈 여부를 예측하고 이에 영향을 미치는 다양한 특성을 분석하는 웹 서비르를 제작하였습니다.
